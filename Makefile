#############################################################################
# Makefile for building: MSIKLM_GUI
# Generated by qmake (3.1) (Qt 5.14.1)
# Project:  src/MSIKLM_GUI.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile src/MSIKLM_GUI.pro -spec linux-g++ CONFIG+=qtquickcompiler
#############################################################################
...
INCPATH       = -Isrc -I. -isystem /usr/include/qt -isystem /usr/include/qt/QtWidgets -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtCore -I. -I. -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
SOURCES       = src/main.cpp \
		src/mainwindow.cpp \
		src/msiklm.c qrc_iconsAndStuff.cpp \
		moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		msiklm.o \
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		src/src/MSIKLM_GUI.pro src/mainwindow.h \
		src/msiklm.h src/main.cpp \
		src/mainwindow.cpp \
		src/msiklm.c
QMAKE_TARGET  = MSIKLM_GUI
DESTDIR       = 
TARGET        = MSIKLM_GUI
...
MSIKLM_GUI: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: src/MSIKLM_GUI.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		src/MSIKLM_GUI.pro \
		src/iconsAndStuff.qrc
	$(QMAKE) -o Makefile src/MSIKLM_GUI.pro -spec linux-g++ CONFIG+=qtquickcompiler
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/iconsAndStuff.qrc $(DISTDIR)/
	$(COPY_FILE) --parents /usr/lib/qt/mkspecs/features/data/dummy.cpp $(DISTDIR)/
	$(COPY_FILE) --parents src/mainwindow.h src/msiklm.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/mainwindow.cpp src/msiklm.c $(DISTDIR)/
...
compiler_rcc_make_all: qrc_iconsAndStuff.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_iconsAndStuff.cpp
qrc_iconsAndStuff.cpp: src/iconsAndStuff.qrc \
		/usr/bin/rcc \
		src/Apps-nepomuk-icon.png \
		src/Apps-preferences-desktop-icons-icon.png \
		src/Places-folder-grey-icon.png \
		src/Places-folder-yellow-icon.png \
...
moc_predefs.h: /usr/lib/qt/mkspecs/features/data/dummy.cpp
	g++ -pipe -O2 -std=gnu++1z -Wall -Wextra -dM -E -o moc_predefs.h /usr/lib/qt/mkspecs/features/data/dummy.cpp
...
mainwindow.o: src/mainwindow.cpp src/msiklm.h \
		src/mainwindow.h \
		ui_mainwindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mainwindow.o src/mainwindow.cpp

msiklm.o: src/msiklm.c src/msiklm.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o msiklm.o src/msiklm.c

qrc_iconsAndStuff.o: qrc_iconsAndStuff.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_iconsAndStuff.o qrc_iconsAndStuff.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/MSIKLM_GUI/bin || mkdir -p $(INSTALL_ROOT)/opt/MSIKLM_GUI/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/MSIKLM_GUI/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/MSIKLM_GUI/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/MSIKLM_GUI/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/MSIKLM_GUI/bin/ 
